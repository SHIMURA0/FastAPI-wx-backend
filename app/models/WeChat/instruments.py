...
class Instruments(Base):
    ...
    # Core information
    code: str = Column(String(255), primary_key=True, nullable=False, unique=True, comment="device code")
    ...
    room_id: str = Column(Integer, nullable=True, comment="device room id")
